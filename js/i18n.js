...
(function () {
  ...
  const DICT = {
    ...
    "launcher.yoga.desc": { en: "Learn and practice yoga and evaluate with AI assistance.", hi: "योग सीखें और अभ्यास करें और AI सहायता से मूल्यांकन करें।" },
    ...
    "launcher.chronic.title": { en: "Consult with Health Professional", hi: "स्वास्थ्य विशेषज्ञ से परामर्श करें" },
    "launcher.chronic.desc": { en: "Consult our health professional to manage Diabetes, Eye Condition & Hypertension.", hi: "मधुमेह, नेत्र समस्या और उच्च रक्तचाप के प्रबंधन के लिए हमारे स्वास्थ्य विशेषज्ञ से परामर्श करें।" },
